...
Preguntas comunes sobre Switchboard.

---

## ¿Qué es Switchboard?

**Switchboard es un router de modelos de IA que maximiza el valor de tu suscripción y minimiza los costos.**
...
**Switchboard usa una estrategia de precios de 3 niveles:**
...
## ¿Switchboard es gratis?

**Sí, Switchboard en sí es 100% gratis y open source.**
...
**¡Sí! Esta es la característica principal de Switchboard.**
...
**Switchboard rastrea la cuota en tiempo real para todos los proveedores:**
...
## ¿Puedo auto-hospedar Switchboard?

**¡Sí! Switchboard soporta múltiples opciones de despliegue:**
...
- `DATA_DIR` - Ruta de almacenamiento de la base de datos (por defecto: `~/.switchboard`)
...
**Sí, Switchboard prioriza la seguridad y privacidad:**

**Almacenamiento local:**
- Todos los datos se almacenan localmente en `~/.switchboard` (o `DATA_DIR` personalizado)
- No se envían datos a los servidores de Switchboard
...
- Respalda `~/.switchboard` antes de actualizaciones mayores
...
- **Documentación:** [switchboard.com/docs](/docs)
- **GitHub:** [github.com/switchboard]()
- **Issues:** [github.com/switchboard/issues](/issues)
