...
Pon en marcha Switchboard en 5 minutos y comienza a enrutar solicitudes de IA de forma inteligente.
...
Apunta tu herramienta de codificación a Switchboard:
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [desde el dashboard de switchboard]
