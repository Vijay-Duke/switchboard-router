...
Problemas comunes y soluciones al usar Switchboard.
...
1. **Refresh automático (por defecto):**
   Switchboard refresca automáticamente los tokens. Espera 30 segundos y reintenta.
...
**Causas:**
- Switchboard no está ejecutándose
- Puerto 20128 bloqueado
- Firewall bloqueando la conexión

**Soluciones:**

1. **Inicia Switchboard:**
   ```bash
   switchboard
   ```
...
1. **Verifica si Switchboard está ejecutándose:**
   ```bash
   # Verifica el proceso
