...
Switchboard es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

Switchboard proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a Switchboard usando estas configuraciones:

**Switchboard local:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de Switchboard (cc/*, cx/*, glm/*, etc.)
```

**Switchboard en la nube:**
```
Base URL: /v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de Switchboard (cc/*, cx/*, glm/*, etc.)
...
**Problema:** No se puede conectar a Switchboard
```bash
# Verifica si Switchboard está corriendo
...
**Solución:**
- Verifica que Switchboard esté corriendo
...
- Verifica la conexión de red a Switchboard
