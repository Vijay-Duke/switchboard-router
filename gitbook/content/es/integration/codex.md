...
Integra Switchboard con OpenAI Codex CLI para enrutar tus solicitudes de la API de OpenAI a través del sistema de enrutamiento inteligente de Switchboard.
...
```bash
# Base URL for Switchboard
export OPENAI_BASE_URL="http://localhost:20128/v1"

# API Key from Switchboard dashboard
export OPENAI_API_KEY="your-switchboard-api-key"
```
...
Switchboard proporciona los siguientes modelos de Codex:
...
```json
{
  ...
  "apiKey": "your-switchboard-api-key",
...
1. Verifica que tu API key sea correcta en el dashboard de Switchboard
...
1. Verifica que el nombre del modelo coincida con tu configuración de Switchboard
2. Verifica que la conexión del proveedor de OpenAI esté activa en el dashboard de Switchboard
...
Asegúrate de haber configurado tu API key en el dashboard en la nube de Switchboard.
