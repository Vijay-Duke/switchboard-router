...
Integra Switchboard con la extensión Cline de VSCode para enrutar tus solicitudes de IA a través del sistema de enrutamiento inteligente de Switchboard.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Cline instalada desde el marketplace de VSCode
- Switchboard ejecutándose localmente o endpoint en la nube configurado
- API key del dashboard de Switchboard
...
Establece la URL base a tu endpoint de Switchboard:

**Para Switchboard local:**
```
http://localhost:20128/v1
```

**Para Switchboard en la nube:**
```

```

**Pasos:**
1. En el campo **Base URL**, ingresa tu endpoint de Switchboard
2. Asegúrate de incluir `/v1` al final

### 4. Agregar API Key

1. En el campo **API Key**, ingresa tu API key de Switchboard
2. Puedes encontrar tu API key en el dashboard de Switchboard en **Settings → API Keys**
3. La key debe comenzar con `sk-switchboard-`

### 5. Seleccionar modelo

1. En el dropdown **Model**, puedes:
   - Seleccionar de los modelos disponibles (si Cline los auto-detecta)
   - Ingresar manualmente el nombre del modelo desde tu configuración de Switchboard
...
Puedes usar cualquier modelo configurado en tu dashboard de Switchboard. Ejemplos comunes:
...
4. Cline usará Switchboard para procesar tu solicitud

### Generación de código

1. Pide a Cline que genere código: "Create a React component for a login form"
2. Cline generará código usando Switchboard
...
3. Obtén explicaciones potenciadas por IA a través de Switchboard

### Operaciones con archivos

1. Pide a Cline que cree, modifique o elimine archivos
2. Cline usará Switchboard para entender el contexto y hacer cambios
...
1. Verifica que Switchboard esté corriendo: `curl http://localhost:20128/health`
...
1. Verifica tu API key en el dashboard de Switchboard
2. Asegúrate de haber copiado la key completa incluyendo el prefijo `sk-switchboard-`
3. Verifica que la API key no haya expirado
4. Intenta regenerar una nueva API key

### Error "Model Not Found"

1. Verifica que el nombre del modelo coincida exactamente con tu configuración de Switchboard
2. Verifica que la conexión del proveedor esté activa en el dashboard de Switchboard
...
2. Verifica que tu instancia de Switchboard esté ejecutándose y saludable
3. Intenta recargar la ventana de VSCode (Cmd/Ctrl + Shift + P → "Reload Window")
4. Revisa los logs de Switchboard para cualquier error

## Configuración avanzada

### Usar endpoint en la nube

Para usar el endpoint en la nube de Switchboard en lugar de localhost:

1. En la configuración de Cline, establece Base URL a: ``
2. Asegúrate de haber configurado tu API key en el dashboard en la nube de Switchboard
...
2. **Monitorea el uso**: Revisa el dashboard de Switchboard para estadísticas de uso y costos
...
## Integración con características de Switchboard

### Enrutamiento de modelos

Switchboard enruta automáticamente tus solicitudes al mejor proveedor disponible según:
...
Si un proveedor falla, Switchboard automáticamente cambia a proveedores alternativos configurados en tu dashboard.

### Seguimiento de uso

Monitorea tu uso de Cline a través del dashboard de Switchboard:
