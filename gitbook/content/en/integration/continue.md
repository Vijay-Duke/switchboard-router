...
Integrate Switchboard with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- Switchboard API key from [dashboard](/dashboard)
- Switchboard running (local or cloud)
...
### 2. Add Switchboard Model Configuration
...
3. Choose your preferred Switchboard model
...
- Check network latency to Switchboard
