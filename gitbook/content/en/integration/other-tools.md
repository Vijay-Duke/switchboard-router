...
Switchboard is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

Switchboard provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to Switchboard using these settings:
...
**Problem:** Cannot connect to Switchboard
```bash
...
- Check network connection to Switchboard
