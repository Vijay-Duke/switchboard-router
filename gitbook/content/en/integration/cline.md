...
Integrate Switchboard with Cline VSCode extension to route your AI requests through Switchboard's intelligent routing system.

## Prerequisites

- Visual Studio Code installed
- Cline extension installed from VSCode marketplace
- Switchboard running locally or cloud endpoint configured
...
Set the base URL to your Switchboard endpoint:

**For Local Switchboard:**
```
http://localhost:20128/v1
```

**For Cloud Switchboard:**
```

```

**Steps:**
1. In the **Base URL** field, enter your Switchboard endpoint
...
3. The key should start with `sk-switchboard-`

### 5. Select Model

1. In the **Model** dropdown, you can either:
   - Select from available models (if Cline auto-detects them)
   - Manually enter the model name from your Switchboard configuration
...
4. Cline will use Switchboard to process your request

### Code Generation

1. Ask Cline to generate code: "Create a React component for a login form"
2. Cline will generate code using Switchboard
...
3. Get AI-powered explanations through Switchboard

### File Operations

1. Ask Cline to create, modify, or delete files
2. Cline will use Switchboard to understand context and make changes
...
1. Verify Switchboard is running: `curl http://localhost:20128/health`
...
2. Verify your Switchboard instance is running and healthy
3. Try reloading VSCode window (Cmd/Ctrl + Shift + P → "Reload Window")
4. Check Switchboard logs for any errors

## Advanced Configuration

### Using Cloud Endpoint

To use Switchboard cloud endpoint instead of localhost:

1. In Cline settings, set Base URL to: ``
2. Make sure you have configured your API key in the Switchboard cloud dashboard
...
## Integration with Switchboard Features

### Model Routing

Switchboard automatically routes your requests to the best available provider based on:
- Model availability
...
If a provider fails, Switchboard automatically falls back to alternative providers configured in your dashboard.

### Usage Tracking

Monitor your Cline usage through Switchboard dashboard:
- Total requests
- Token usage
- Cost per model
