...
Integrate Switchboard with Claude Code CLI to route your Anthropic API requests through Switchboard's intelligent routing system.
...
Claude Code supports the following model aliases that map to Switchboard models:
