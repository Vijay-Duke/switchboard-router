...
Integrate Switchboard with OpenAI Codex CLI to route your OpenAI API requests through Switchboard's intelligent routing system.
...
Switchboard provides the following Codex models:
...
1. Verify your API key is correct in Switchboard dashboard
...
1. Verify the model name matches your Switchboard configuration
2. Check that the OpenAI provider connection is active in Switchboard dashboard
...
Make sure you have configured your API key in the Switchboard cloud dashboard.
