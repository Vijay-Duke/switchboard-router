...
**Switchboard is an AI model router that maximizes your subscription value and minimizes costs.**
...
**Switchboard uses a 3-tier pricing strategy:**
...
**Yes, Switchboard itself is 100% free and open source.**
...
**Yes! This is Switchboard's core feature.**
...
**Switchboard tracks quota in real-time for all providers:**
...
**Yes! Switchboard supports multiple deployment options:**
...
- `DATA_DIR` - Database storage path (default: `~/.switchboard`)
...
**Yes, Switchboard prioritizes security and privacy:**

**Local storage:**
- All data stored locally in `~/.switchboard` (or custom `DATA_DIR`)
- No data sent to Switchboard servers
...
**What Switchboard stores:**
- Provider OAuth tokens (encrypted)
- API keys (encrypted)
- Usage statistics (local only)
- Combo configurations

**What Switchboard does NOT store:**
...
- Backup `~/.switchboard` before major updates
