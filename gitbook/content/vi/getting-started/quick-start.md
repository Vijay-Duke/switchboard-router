...
Khởi chạy Switchboard trong 5 phút và bắt đầu định tuyến các request AI một cách thông minh.
...
Trỏ công cụ code của bạn tới Switchboard:
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [from switchboard dashboard]
