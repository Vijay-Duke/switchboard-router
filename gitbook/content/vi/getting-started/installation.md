...
Hướng dẫn cài đặt chi tiết cho Switchboard với mẹo troubleshooting.
...
Cài Switchboard toàn cục để dùng ở bất kỳ đâu:

```bash
npm install -g switchboard-router
```

**Khởi động Switchboard:**
...
**Lợi ích:**
- ✅ Chạy từ mọi thư mục
- ✅ Lệnh đơn giản: `switchboard`
- ✅ Auto-update với `npm update -g switchboard`
...
3. Data directory được tạo tại `~/.switchboard`
...
**Vấn đề:** Switchboard dùng quá nhiều RAM
...
# Delete switchboard-related exports
```
