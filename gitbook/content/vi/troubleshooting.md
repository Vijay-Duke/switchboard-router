...
Các vấn đề và giải pháp phổ biến khi dùng Switchboard.
...
1. **Auto-refresh (mặc định):**
   Switchboard tự refresh tokens. Đợi 30 giây rồi thử lại.
...
**Nguyên nhân:**
- Switchboard không chạy
- Port 20128 bị chặn
- Firewall chặn kết nối

**Giải pháp:**

1. **Khởi động Switchboard:**
   ```bash
   switchboard
   ```
...
- Switchboard bị crash
- Vấn đề cache browser

**Giải pháp:**

1. **Kiểm tra Switchboard có chạy không:**
   ```bash
   # Check process
