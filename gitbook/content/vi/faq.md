...
Những câu hỏi phổ biến về Switchboard.

---

## Switchboard là gì?

**Switchboard là bộ định tuyến mô hình AI giúp tối đa hóa giá trị subscription và giảm chi phí.**
...
**Switchboard dùng chiến lược pricing 3 tầng:**
...
## Switchboard có miễn phí không?

**Có, Switchboard hoàn toàn miễn phí và mã nguồn mở 100%.**
...
**Có! Đây là tính năng cốt lõi của Switchboard.**
...
**Switchboard theo dõi quota thời gian thực cho tất cả provider:**
...
## Tôi có thể self-host Switchboard không?

**Có! Switchboard hỗ trợ nhiều tùy chọn deployment:**
...
- `DATA_DIR` - Đường dẫn lưu database (mặc định: `~/.switchboard`)
...
**Có, Switchboard ưu tiên bảo mật và quyền riêng tư:**

**Local storage:**
- Mọi dữ liệu lưu cục bộ tại `~/.switchboard` (hoặc `DATA_DIR` tùy chỉnh)
- Không gửi data đến server Switchboard
...
## Làm thế nào để cập nhật Switchboard?
...
- Backup `~/.switchboard` trước khi update lớn
