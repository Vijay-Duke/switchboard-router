...
Triển khai Switchboard trên VPS hoặc Docker để truy cập từ xa và dùng trong production.
...
| `DATA_DIR` | `~/.switchboard` | Đường dẫn lưu database và data |
...
Tạo `/etc/nginx/sites-available/switchboard`:
...
# If NOT using reverse proxy, allow Switchboard ports
