...
Tích hợp Switchboard với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- Switchboard API key từ [dashboard](/dashboard)
- Switchboard đang chạy (cục bộ hoặc cloud)
...
### 2. Thêm Cấu hình Model Switchboard
...
3. Chọn model Switchboard ưa thích
...
- Kiểm tra Switchboard đang chạy: `curl http://localhost:20128/health`
...
- Kiểm tra độ trễ network đến Switchboard
