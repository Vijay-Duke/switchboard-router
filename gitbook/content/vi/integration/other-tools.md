...
Switchboard tương thích với mọi công cụ hỗ trợ format API OpenAI. Hướng dẫn này bao gồm pattern tích hợp tổng quát cho nhiều công cụ và ứng dụng tùy chỉnh.

## Tổng quan

Switchboard cung cấp API endpoint tương thích OpenAI hoạt động với:
...
Mọi công cụ tương thích OpenAI có thể kết nối đến Switchboard bằng các cài đặt sau:

**Switchboard cục bộ:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: any Switchboard model (cc/*, cx/*, glm/*, etc.)
```
...
**Vấn đề:** Không kết nối được đến Switchboard
```bash
...
**Giải pháp:**
- Xác minh Switchboard đang chạy
...
- Kiểm tra kết nối network đến Switchboard
