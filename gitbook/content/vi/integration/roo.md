...
Tích hợp Switchboard với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
Chọn từ các model Switchboard có sẵn:
...
### Connection Failed
- Xác minh Switchboard đang chạy: `curl http://localhost:20128/health`
