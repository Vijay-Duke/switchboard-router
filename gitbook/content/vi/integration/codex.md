...
Tích hợp Switchboard với OpenAI Codex CLI để định tuyến request API OpenAI qua hệ thống routing thông minh của Switchboard.
...
Switchboard cung cấp các model Codex sau:
...
1. Xác minh API key đúng trong Switchboard dashboard
...
1. Xác minh tên model khớp với cấu hình Switchboard
2. Kiểm tra kết nối provider OpenAI đang hoạt động trong Switchboard dashboard
...
Đảm bảo bạn đã cấu hình API key trong Switchboard cloud dashboard.
