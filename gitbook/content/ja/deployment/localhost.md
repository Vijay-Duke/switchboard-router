...
開発と個人利用のため、ローカルマシンでSwitchboardを実行。

---

## 📦 インストール

npm経由でSwitchboardをグローバルインストール:
...
Switchboardが実行されているターミナルで `Ctrl+C` を押します。

```bash
# switchboardを実行しているターミナル
^C  # Ctrl+Cを押す
```
