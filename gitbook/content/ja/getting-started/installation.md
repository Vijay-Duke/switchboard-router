...
トラブルシューティングのヒント付きのSwitchboard詳細インストールガイド。
...
どこからでも使用できるようにSwitchboardをグローバルインストール:
...
**利点:**
- ✅ どのディレクトリからでも実行
- ✅ シンプルなコマンド: `switchboard`
- ✅ `npm update -g switchboard` で自動更新
...
3. `~/.switchboard` にデータディレクトリが作成される
4. APIキーが自動生成される
