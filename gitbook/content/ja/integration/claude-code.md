...
SwitchboardをClaude Code CLIと統合し、AnthropicのAPIリクエストをSwitchboardのインテリジェントルーティングシステム経由でルーティングします。
...
Claude CodeはSwitchboardモデルにマッピングされる以下のモデルエイリアスをサポート:
...
1. モデル名がSwitchboardの設定と一致しているか確認
