...
import { allocateUniquePrefix } from "@/lib/providerNodePrefix";
...
export async function POST(request) {
  try {
    ...
    // Prefix is auto-derived from name (not user-facing).
    const prefix = allocateUniquePrefix(name.trim(), existing);
