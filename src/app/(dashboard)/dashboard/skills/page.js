    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <Card padding="md">
        <div className="flex items-center justify-between gap-2 mb-2">
          <div className="text-xs text-text-muted">Paste this to your AI:</div>
          <CopyButton value={`Read this skill and use it: ${entryRaw || getSkillRawUrl("switchboard")}`} label="Copy prompt" />
        </div>
        <div className="px-3 py-2 rounded bg-surface-2 font-mono text-[12px] text-text-main break-all border border-border/50">
