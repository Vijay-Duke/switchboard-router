const moduleDefault = {
  ...
  // CommandCode's legacy alpha transport has no /models route. Keep model
  // discovery on the authenticated Provider API instead of deriving
  // /alpha/generate/models from the chat transport URL.
  modelsFetcher: {
