 ...
 * into switchboard-shaped variants:
 *
 *   {upstream}                          - base model
 ...
 * API. They are switchboard fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic switchboard variant set for a single upstream Kiro model.
 *
 ...
 * into switchboard variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
