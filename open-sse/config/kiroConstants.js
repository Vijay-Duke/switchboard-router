 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what switchboard needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a switchboard
...
/**
 * Detect whether a model id refers to a switchboard synthetic agentic variant.
...
/**
 * Detect whether a model id is a switchboard synthetic thinking variant
...
/**
 * Resolve a switchboard model id to the real upstream Kiro model id, plus flags
