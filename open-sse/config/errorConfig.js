...
// Hard cap for provider-reported precise cooldowns (codex resets_at spans hours to days;
// a short cap re-probes a usage-limited account every cycle until the real reset).
export const MAX_RATE_LIMIT_COOLDOWN_MS = 24 * 60 * 60 * 1000;
