/**
 * Port of upstream 10a923da: some providers (e.g. codebuddy/cbcn) attach an
 * empty tool_calls array to every streaming chunk. An empty array is truthy in
 * JS, so the old guard closed the message on the first content token and
 * emitted response.output_text.done early, dropping the remaining deltas.
 */
